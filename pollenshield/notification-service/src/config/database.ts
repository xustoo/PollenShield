...
export const mongodbUri = process.env.MONGODB_URI || "mongodb://localhost:27017/pollenshield_notifications";
...
export const connectDatabase = async (retries = 10): Promise<void> => {
  ...
  throw new Error("Could not connect Notification Service to MongoDB");
};
